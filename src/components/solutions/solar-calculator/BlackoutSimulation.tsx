            ...
            <div className="flex justify-between items-center">
                <div>
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-bold uppercase tracking-wider bg-red-500/10 text-red-400 mb-4">
                        ...
                        {t('calculator.blackout.title')}
                    </div>
                    <h2 className="text-5xl font-bold font-display text-white">{t('calculator.blackout.subtitle')}</h2>
                </div>
                <button
                    onClick={onRestore}
            ...
            <div className="grid lg:grid-cols-2 gap-12">
                ...
                <div className="space-y-8 p-8 rounded-3xl border border-red-900/30 bg-red-950/10">
                    <h3 className="text-2xl font-bold text-red-500 flex items-center gap-3">
                        ...
                        {t('calculator.blackout.batteryLevel')}
                    </h3>
                    ...
                    <div className="relative h-48 w-full bg-black rounded-2xl border border-red-900/30 overflow-hidden flex items-center justify-center">
                        ...
                        <div className="z-10 text-center">
                            ...
                            <div className="text-red-400 font-mono text-sm tracking-widest mt-2">
                                {t('calculator.blackout.autonomy')} : {Math.floor(batteryLevel / 10)}h {Math.floor((batteryLevel % 10) * 6)}m
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="space-y-6">
                    <h3 className="text-xl font-bold text-slate-300 mb-6">{t('calculator.blackout.activeLoads')}</h3>
                    ...
                    <div className="flex items-center justify-between p-6 rounded-2xl bg-white/5 border border-white/10">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <div className="font-bold text-white">{t('calculator.blackout.loads.fridge')}</div>
                                <div className="text-xs text-slate-400">{t('calculator.blackout.loads.consumption', { value: 150 })}</div>
                            </div>
                        </div>
                    ...
                    <div className="flex items-center justify-between p-6 rounded-2xl bg-white/5 border border-white/10">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <div className="font-bold text-white">{t('calculator.blackout.loads.wifi')}</div>
                                <div className="text-xs text-slate-400">{t('calculator.blackout.loads.consumption', { value: 15 })}</div>
                            </div>
                        </div>
                        <div className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></div>
                    </div>
                    ...
                    <div className="flex items-center justify-between p-6 rounded-2xl bg-white/5 border border-white/10">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <div className="font-bold text-white">{t('calculator.blackout.loads.lights')}</div>
                                <div className="text-xs text-slate-400">{t('calculator.blackout.loads.consumption', { value: 40 })}</div>
                            </div>
                        </div>
                        <div className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></div>
                    </div>
